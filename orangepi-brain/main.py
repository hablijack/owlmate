"""
Robot Owl OrangePi Brain - Main Entry Point

Starts the serial communication loop and supervisor. The ESP32 owns the
behavior state machine; the OrangePi supervisor only logs telemetry and can
send policy commands (sleep/wake) and temporary overrides.
"""
...
def main():
    ...
    # Optional speech recognition: hears the user (I2S mic) and reacts via the
