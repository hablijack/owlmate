"""
Robot Owl OrangePi Brain - Navigation controller.

The owl acts as a compass that points at a named destination. The OrangePi owns all
...
Exit (see specs/013-navigation.spec, "four ways out") -- any of these ends it:
  ...
  * a self-timeout (no telemetry for timeout_s -> the OrangePi drops it; the
