#!/usr/bin/env python3
"""
Run the Robot Owl OrangePi brain test suite.
...
OrangePi, NO microphone, and NO faster-whisper/PortAudio installed -- the
third-party modules are stubbed out (see tests/stubs.py). The only hard
dependency is numpy (a normal project dependency).

On the OrangePi itself the same suite runs against the real installed
