...
Skips when the repo root is not present — setup.sh installs only orangepi-brain/ onto
the OrangePi, so a deployed brain has no specs/ or BACKLOG.md to check.
...
@unittest.skipUnless(os.path.exists(CHECKER), "repo root not present (deployed OrangePi)")
