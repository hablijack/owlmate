...
How it is exercised WITHOUT hardware:
  * The auto-sleep policy lives on the OrangePi supervisor. We drive the REAL
...
OrangePi's only new job is (a) deciding when the environment is quiet enough to send
...
class TestAutoSleepPolicy(unittest.TestCase):
    """The OrangePi supervisor puts the owl to sleep after sustained inactivity."""
